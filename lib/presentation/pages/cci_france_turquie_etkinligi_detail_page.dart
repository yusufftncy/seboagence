/// 🏢 CCI France Turquie Etkinliği Detail Page - CCI France Turquie Etkinliği detay sayfası
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInfoRow('Tarih', 'Aralık 2025', Icons.calendar_today),
          const SizedBox(height: 12),
          ...
          const SizedBox(height: 12),
          _buildInfoRow('Katılımcı Sayısı', '150+', Icons.people),
        ],
      ),
    );
  }
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Farklı sektörlerden profesyoneller, iş dünyası liderleri ve ticaret odası temsilcileri katıldı.',
                      style: AppTypography.bodySmall.copyWith(
                        color: const Color(0xFF6B6B6B),
                        height: 1.4,
                      ),
